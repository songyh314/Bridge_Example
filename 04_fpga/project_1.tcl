...
#
# Generated by Vivado on Wed Nov 06 11:11:24 +0800 2024
...
#
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/project_1/hs_bridge_tb_behav.wcfg"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/01_rtl/RAM.sv"
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/01_rtl/fifo.sv"
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/01_rtl/hs_bridge.sv"
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/02_sim/tb_fifo.sv"
#    "D:/WORK_FOLDER/REPO/myWORK/handshake-bridge/02_sim/tb_bridge.sv"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../project_1/hs_bridge_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../01_rtl/RAM.sv"]"\
 "[file normalize "$origin_dir/../01_rtl/fifo.sv"]"\
 "[file normalize "$origin_dir/../01_rtl/hs_bridge.sv"]"\
 "[file normalize "$origin_dir/../02_sim/tb_fifo.sv"]"\
 "[file normalize "$origin_dir/../02_sim/tb_bridge.sv"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/../01_rtl/RAM.sv"
...
set file "$origin_dir/../01_rtl/fifo.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../01_rtl/hs_bridge.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "hs_bridge" -objects $obj
...
set file "$origin_dir/../02_sim/tb_fifo.sv"
set file [file normalize $file]
...
# Create 'bridge_tb' fileset (if not found)
if {[string equal [get_filesets -quiet bridge_tb] ""]} {
  create_fileset -simset bridge_tb
}

# Set 'bridge_tb' fileset object
set obj [get_filesets bridge_tb]
set files [list \
 [file normalize "${origin_dir}/../02_sim/tb_bridge.sv"] \
]
add_files -norecurse -fileset $obj $files
...
set imported_files ""
foreach f $files {
  lappend imported_files [import_files -fileset bridge_tb $f]
}

# Set 'bridge_tb' fileset file properties for remote files
set file "$origin_dir/../02_sim/tb_bridge.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets bridge_tb] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
# Set 'bridge_tb' fileset file properties for local files
set file "project_1/hs_bridge_tb_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets bridge_tb] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
# Set 'bridge_tb' fileset properties
set obj [get_filesets bridge_tb]
set_property -name "32bit" -value "0" -objects $obj
set_property -name "configure_for_gui_mode" -value "0" -objects $obj
set_property -name "define" -value "" -objects $obj
...
set_property -name "include_dirs" -value "" -objects $obj
set_property -name "incremental" -value "1" -objects $obj
set_property -name "name" -value "bridge_tb" -objects $obj
set_property -name "nl.cell" -value "" -objects $obj
set_property -name "nl.incl_unisim_models" -value "0" -objects $obj
set_property -name "nl.process_corner" -value "slow" -objects $obj
set_property -name "nl.rename_top" -value "" -objects $obj
...
set_property -name "source_set" -value "sources_1" -objects $obj
set_property -name "systemc_include_dirs" -value "" -objects $obj
set_property -name "top" -value "hs_bridge_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "transport_int_delay" -value "0" -objects $obj
set_property -name "transport_path_delay" -value "0" -objects $obj
